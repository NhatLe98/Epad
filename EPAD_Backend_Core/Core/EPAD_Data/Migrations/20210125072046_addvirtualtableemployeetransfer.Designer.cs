...
namespace EPAD_Data.Migrations
{
    ...
    [Migration("20210125072046_addvirtualtableemployeetransfer")]
    partial class addvirtualtableemployeetransfer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPAD_Backend_Core.Models.IC_EmployeeTransfer", b =>
                {
                    ...
                    b.Property<int?>("IC_DepartmentIndex");
            ...
            modelBuilder.Entity("EPAD_Backend_Core.Models.IC_EmployeeTransfer", b =>
                {
                    b.HasOne("EPAD_Backend_Core.Models.IC_Department", "IC_Department")
                        .WithMany()
                        .HasForeignKey("IC_DepartmentIndex");

                    b.HasOne("EPAD_Backend_Core.Models.IC_Employee", "IC_Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeATID", "CompanyIndex")

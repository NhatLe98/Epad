...
{
    public partial class addcolumnTA_AjustAttendanceLogHistory : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TA_AjustAttendanceLogHistory",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TA_AjustAttendanceLogHistory", x => x.Index);
                });
        }

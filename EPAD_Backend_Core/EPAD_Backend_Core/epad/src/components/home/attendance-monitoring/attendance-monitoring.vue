            ...
            <div style="height: 90%;">
              ...
              <el-row style="height:75%">
                <el-col class="colBorder" :span="11">
                  <el-table height="calc(90%)" class="attendance-monitoring__table"
                    :row-class-name="tableRowDetailClassName"
                    style="margin-top: 0; text-align: center;"
                    :data="tblData.filter((_, idx) => idx % 2 === 0)" @row-click="rowClicked" border
                    empty-text=" ">
                    <el-table-column prop="Area" :label="$t('Gate')">
                      <template #default="scope">
                        <span v-html="scope ? scope.row.Area : ''"></span><br/>
                        <span style="font-size:26px" v-html="scope ? scope.row.AreaDescription : ''"></span>
                      </template>
                    </el-table-column>
...
<script lang="ts" src="./attendance-monitoring.ts"></script>

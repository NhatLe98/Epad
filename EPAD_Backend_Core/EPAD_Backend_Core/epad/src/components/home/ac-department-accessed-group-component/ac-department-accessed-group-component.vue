    ...
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="12" class="left">
            <span id="FormName">{{ $t("ACDepartmentAccessedGroup") }}</span>
          </el-col>
          <el-col :span="12">
            <HeaderComponent />
          </el-col>
      ...
      <el-main class="bgHome">
        <div>
          <el-dialog
            :title="
              isEdit ? $t('EditDepartmentAccessedGroup') : $t('InsertDepartmentAccessedGroup')
            "
          ...
          <el-row>
            <el-col :span="4">
              <select-department-tree-component
                ...
                :props="tree.treeProps"
                :isSelectParent="true"
                :checkStrictly="tree.checkSrictly"
                :clearable="tree.clearable"
                :popoverWidth="tree.popoverWidth"
...
<script src="./ac-department-accessed-group-component.ts"></script>
<style lang="scss">
.br {

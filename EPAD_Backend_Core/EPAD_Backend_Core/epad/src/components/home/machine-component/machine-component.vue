<template>
  <div id="bgHome">
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="12" class="left">
            <span id="FormName">{{ $t("ListMachine") }}</span>
          </el-col>
          <el-col :span="12">
            <HeaderComponent />
          </el-col>
      ...
      <el-main class="bgHome machine-el-main">
        <div>
          <el-dialog
            ...
            >
              ...
              <el-row>
                <el-col :span="12" style="padding-right: 30px">
                  ...
                  >
                    <el-input
                      ref="AttendanceLogCapacity"
                      v-model="ruleForm.AttendanceLogCapacity"
                ...
                <el-col :span="12" style="padding-right: 30px">
                  ...
                  >
                    <el-input
                      ref="FingerCapacity"
                      v-model="ruleForm.FingerCapacity"
                      onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                    ></el-input>
                  </el-form-item>
                  <el-form-item
                  ...
                  <el-form-item
                    :label="$t('Account')"
                    @click.native="focus('Account')"
                    prop="Account"
                    v-if="ruleForm.DeviceModule == 'PA'"
                  >
                    <el-input
                      ref="Account"
                ...
                <el-col :span="6" class="selection-service">
                  <el-row :span="6" v-if="ruleForm.DeviceModule == 'PA'">
                    <el-form-item
                      :label="$t('ParkingType')"
                      @click.native="focus('ParkingType')"
                      prop="ParkingType"
                    >
                      <el-select
                        ref="ParkingType"
                        filterable
                        :placeholder="$t('ParkingList')"
              ...
              <el-row >
                <el-col :span="24">
                  <el-form-item style="margin-left: 15px;">
                    <el-checkbox v-model="ruleForm.IsUsingOffline">{{ $t("OfflineMachine") }}</el-checkbox>
                  </el-form-item>
                </el-col>
              </el-row>
        ...
        <div>
          <data-table-function-component
            ...
            @edit="Edit"
            @delete="Delete"
            @upload-hardware-license="showDialogImportLicense = true"
...
<script src="./machine-component.ts"></script>
<style lang="scss">
.machine-el-main {
  .el-upload-dragger,
  ...
  .device-module-checklist .el-checkbox {
    display: block;
  }
  .radio-device-module .el-radio {
    display: block;
    margin-bottom: 10px;
  }
  .dialog-machine .el-dialog {
    width: 60%;
  }
}
</style>
...
export default class SyntheticAttendanceComponent extends Mixins(TabBase) {
	page = 1;
	showDialog = false;
	showMessage = false;
	checked = false;
	...
	listColumn = [];
	listData = [];
	filterModel = { Departments: [], EmployeeATIDs: [], TextboxSearch: '', FromDate: new Date(), ToDate: new Date(), filerByLog: null };
	lock = false;
	listOptionFilterLog = [

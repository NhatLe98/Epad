<template>
  <div id="bgHome">
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="12" class="left">
            <span id="FormName">{{ $t("VehicleMonitoringHistoryPage") }}</span>
          </el-col>
          <el-col :span="12">
      ...
      <el-row >
        <el-col :span="3">
          <select-department-tree-component
            class="vehicle-monitoring-history__department-select-tree"
        ...
        <el-col :span="3" style="margin-left: 10px;">
          <app-select-new class="vehicle-monitoring-history_employee-select"
        ...
        <el-col :span="6">
          <el-input
            ...
            :placeholder="$t('InputPlateMCCMNVName')"
            suffix-icon="el-icon-search"
            v-model="ruleObject.Filter"
      ...
      <el-row>
        <data-table-component class="vehicle-monitoring-history__data-table"
          :get-data="getData"
          ref="table"
          :columns="columns"
...
<script src="./vehicle-monitoring-history.ts" />

<style lang="scss">
.vehicle-monitoring-history__data-table {
  .el-table{
...
.vehicle-monitoring-history__department-select-tree {
...
.vehicle-monitoring-history_employee-select {

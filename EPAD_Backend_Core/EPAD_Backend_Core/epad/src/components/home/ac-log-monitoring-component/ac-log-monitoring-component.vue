<template>
    <div id="bgHome">
        <el-container>
            <el-header>
                <el-row>
                    <el-col :span="12" class="left">
                        <span id="FormName">{{ $t("ACLogMonitoring") }}</span>
                    </el-col>
                    <el-col :span="12">
                        <HeaderComponent />
                    </el-col>
            ...
            <div :class="{ 'full-screen fullscreen-container': isFullScreen() }" class="ac-logmonitoring-container" style="overflow-y: hidden;">
                <el-main class="bgHome logmonitoring" style="height: 100vh !important;"
                    :class="{ 'el-main__full-screen': isFullScreen() }">
                    <div style="height:46px;">
                        <el-alert style="height:100%;" class="center16px"
                            :title="$t('ConnectToMonitoringServerSuccessfully')" type="success" :closable="false"
                            effect="dark" v-if="isConnect"></el-alert>
                        <el-alert style="height:100%;" class="center16px" :title="$t('NotConnectServerMonitoring')"
                            type="error" :closable="false" effect="dark" v-if="!isConnect"></el-alert>
                    </div>
                    <div class="filterContainer">
                        ...
                        <el-row :gutter="24">
                            <el-col :span="7" 
                                ...
                                <el-select v-model="filter.Area" multiple collapse-tags clearable class="filter"
                                    popper-class="select-dropdown" :placeholder="$t('SelectArea')">
                                    <el-option v-for="item in areaLst" :key="item.value"
                            ...
                            <el-col :span="7"
                                style="padding: 0 0 0 10px;">
                                <el-select v-model="filter.Door" multiple collapse-tags clearable class="filter"
                                    popper-class="select-dropdown" :placeholder="$t('SelectDoor')">
                                    <el-option v-for="item in doorLst" :key="item.value"
                                        :label="` ${item.label}`" :value="item.value">
                                    </el-option>
                                </el-select>
                            </el-col>
                            <el-col :span="7" 
                                ...
                                <select-department-tree-component :defaultExpandAll="tree.defaultExpandAll"
                                    ...
                                    :popoverWidth="tree.popoverWidth" v-model="filter.Department"
                                    style="padding: 0 5px; width: 100%; float: left"></select-department-tree-component>
                            </el-col>
                            <el-col :span="3">
                                <data-table-function-component style="top:0; width:auto; margin-right: 60px;"
...
<script src="./ac-log-monitoring-component.ts"></script>

  ...
  <div id="bgHome">
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="12" class="left">
            <span id="FormName">{{ $t("ListArea") }}</span>
          </el-col>
          <el-col :span="12">
            <HeaderComponent />
          </el-col>
      ...
      <el-main class="bgHome">
        <div>
          <el-dialog :title="isEdit ? $t('EditArea') : $t('InsertArea')" 
          custom-class="customdialog" :visible.sync="showDialog" :before-close="Cancel" :close-on-click-modal="false">
            <el-form
              ...
              label-position="top"
            >
              <el-form-item :label="$t('AreaName')" prop="Name" @click.native="focus('Name')">
...
<script src="./ac-area-component.ts"></script>
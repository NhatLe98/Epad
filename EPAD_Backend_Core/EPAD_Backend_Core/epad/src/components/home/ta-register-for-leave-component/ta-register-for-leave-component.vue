<template>
  <AppLayout :formName="$t('TARegisterForLeave')" :showMasterEmployeeFilter="true">
    <div v-for="tab in tabConfig" :key="tab.id">
          <template v-if="tab.active">
            <t-button-bar
              :model="tab"
              @onInsertClick="onInsertClick(tab)"
...
<script src="./ta-register-for-leave-component.ts"></script>
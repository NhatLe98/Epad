    ...
    <div class="tab">
        ...
        <div class="tab-modal">
            <el-dialog custom-class="customdialog"
                       width="1000px"
                       :title="isEdit ? $t('EditParent') : $t('InsertParent')"
                ...
                <el-form class="h-600"
                    ...
                    <el-row>
                        ...
                        <el-col :xs="12" :sm="8" :md="8" :lg="8" :xl="8" class="p-20">
                            ...
                            <el-form-item :label="$t('ParentOfStudents')"
                                          prop="Students"
                                          :placeholder="$t('SelectClass')">
                                <el-select v-model="formModel.Students" multiple>
                        ...
                        <el-col :xs="12" :sm="8" :md="8" :lg="8" :xl="8" class="p-20">
                            <el-form-item :label="$t('NameOnMachine')" prop="NameOnMachine">
                            ...
                            <el-form-item :label="$t('BirthDay')" prop="BirthDay" style="margin-top: 34px">
                                <el-date-picker ref="BirthDay" v-model="formModel.BirthDay"  type="date" ></el-date-picker>
                            </el-form-item>
        ...
        <div>
            <el-dialog :title="$t('DialogHeaderTitle')" custom-class="customdialog" :visible.sync="showDialogImportError" @close="showOrHideImportError(false)">
                <el-form label-width="168px" label-position="top">
                    ...
                    <el-form-item>
                        <a class="fileTemplate-lbl" href="/Files/ParentImportError.xlsx" download>{{ $t('Download') }}</a>
                    </el-form-item>
                </el-form>
...
<script src="./hr-parent-info.ts"></script>
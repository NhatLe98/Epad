<template>
  <AppLayout :formName="$t('UserManagementCentralization')">
    <div v-for="tab in tabConfig" :key="tab.id">
          <template v-if="tab.active">
            <t-button-bar
              ...
              @onReadGoogleSheetClick="onReadGoogleSheetClick"
            ></t-button-bar>
          </template>
        </div>
        <el-tabs type="card" @tab-click="handleTabClick" v-if="isDoneLoadTabConfig">      
          <el-tab-pane
...
<script src="./user-management-component.ts"></script>
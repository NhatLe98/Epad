  ...
  <div id="bgHome">
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="12" class="left">
            <span id="FormName">{{ $t("ListExcusedLateEntry") }}</span>
          </el-col>
          <el-col :span="12">
      ...
      <el-main class="bgHome">
        <div>
          <el-dialog :title="isEdit ? $t('EditExcusedLateEntry') : $t('InsertExcusedLateEntry')" :visible.sync="showDialog"
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="168px" label-position="top"
              ...
              <el-form-item prop="LateDate" :label="$t('Day')">
                <el-date-picker
                :placeholder="$t('Day')"
                  v-model="ruleForm.LateDate"
                  :disabled="isEdit"
                  type="date"
                ></el-date-picker>
              </el-form-item>
              <el-form-item prop="Description"  :label="$t('Note')">
        ...
        <div>
          <el-dialog :title="$t('DialogHeaderTitle')" custom-class="customdialog" :visible.sync="showDialogImportError"
            ...
            <el-form label-width="168px" label-position="top">
              ...
              <el-form-item>
                <a class="fileTemplate-lbl" href="/Files/Template_ExcusedLateEntry_Error.xlsx" download>{{ $t('Download') }}</a>
              </el-form-item>
            </el-form>
        ...
        <div>
          <el-row class="excused-late-entry__custom-function-bar">
        ...
        <div>
          ...
          class="excused-late-entry__data-table-function" :showButtonColumConfig="true" :gridColumnConfig.sync="columns">
          </data-table-function-component>

          <data-table-component :get-data="getData" ref="table" :selectedRows.sync="rowsObj" :columns="columns"
            class="excused-late-entry__data-table"
          ...
          <el-dialog :title="isAddFromExcel ? $t('AddFromExcel') : $t('DeleteFromExcel')" custom-class="customdialog"
            ...
            <el-form :model="formExcel" ref="formExcel" label-width="168px" label-position="top">
              ...
              <el-form-item :label="$t('DownloadTemplate')">
                <a class="fileTemplate-lbl" href="/Template_ExcusedLateEntry.xlsx" download>{{ $t('Download') }}</a>
              </el-form-item>
...
<script src="./excused-late-entry-component.ts"></script>
<style lang="scss">
.excused-late-entry__data-table {
  .filter-input {
    margin-right: 10px;
  }
}

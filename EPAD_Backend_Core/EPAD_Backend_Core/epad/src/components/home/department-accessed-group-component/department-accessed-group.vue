    ...
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="12" class="left">
            <span id="FormName">{{ $t("DepartmentAccessedGroup") }}</span>
          </el-col>
          <el-col :span="12">
            <HeaderComponent />
          </el-col>
      ...
      <el-main class="bgHome">
        <div>
          <el-row class="approve-change-department__custom-function-bar">
              <el-col :span="5">
                  <select-department-tree-component :defaultExpandAll="tree.defaultExpandAll"
                      ...
                      :checkStrictly="false" :clearable="tree.clearable"
          ...
          <data-table-function-component class="department-accessed-group__data-table-function"
          ...
          <data-table-component class="department-accessed-group__data-table"
            :get-data="getData"
            :filterPlaceHolder="$t('InputDepartmentAndAccessgroup')"
            ref="departmentAccessedGroupTable"
            :columns="columns"
      ...
      <el-dialog :title="isAddFromExcel ? $t('AddFromExcel') : $t('DeleteFromExcel')" custom-class="customdialog"
          ...
          <el-form :model="formExcel" ref="formExcel" label-width="168px" label-position="top">
              ...
              <el-form-item :label="$t('DownloadTemplate')">
                  <a class="fileTemplate-lbl" href="/Template_DepartmentAccessedGroup.xlsx" download>{{ $t("Download") }}</a>
              </el-form-item>
          </el-form>
  ...
  <div>
      ...
      :visible.sync="showDialogImportError" :close-on-click-modal="false"
          ...
          <el-form label-width="168px" label-position="top">
              ...
              <el-form-item>
                  <a class="fileTemplate-lbl" href="/Files/Template_DepartmentAccessedGroup_Error.xlsx" download>{{ $t('Download')
                  }}</a>
              </el-form-item>
          </el-form>
...
<script src="./department-accessed-group.ts"></script>
<style lang="scss">
.el-dialog {
  margin-top: 20px !important;
}

.department-accessed-group__data-table {
  .filter-input {
    margin-right: 10px;
  }
  .el-table {
  ...
  .department-accessed-group__data-table-function {
      .datatable-function{
          .group-btn{
              button{

<template>
  <div id="totalEmployeePresent">
    <el-container>
      <el-header>
        <el-row>
          <el-col :span="12" class="left">
            <span id="FormName">{{ $t("AreaLimitedMonitoringScreen") }}</span>
          </el-col>
          <el-col :span="12">
            <HeaderComponent />
          </el-col>
      ...
      <div :class="{ 'full-screen fullscreen-container': isFullScreen() }" class="area-limited-monitorin-container" style="overflow-y: hidden;">
...
<script lang="ts" src="./area-limited-monitoring-screen-component.ts"></script>
...
.area-limited-monitorin-container {
  .el-table__row {
  cursor: pointer;
}

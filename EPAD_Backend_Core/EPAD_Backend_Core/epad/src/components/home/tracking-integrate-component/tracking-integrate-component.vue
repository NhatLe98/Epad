<template>
    <div id="bgHome" v-loading="loading">
      <el-container>
        <el-header>
          <el-row>
            <el-col :span="12" class="left">
              <span id="FormName">{{ $t("TrackingIntegrate") }}</span>
            </el-col>
            <el-col :span="12">
              <HeaderComponent />
            </el-col>
        ...
        <el-main class="change-department">
          <el-row class="tracking-integrate__custom-function-bar">
          ...
          <div>
            <data-table-component class="tracking-integrate__data-table"
              ref="table"
              :get-data="getData"
              :columns="columns"
              :showCheckbox="false"
  ...
  <script src="./tracking-integrate-component.ts"></script>
  <style lang=scss>
.tracking-integrate__data-table {
  .filter-input {
    margin-right: 10px;
  }
  .el-table {

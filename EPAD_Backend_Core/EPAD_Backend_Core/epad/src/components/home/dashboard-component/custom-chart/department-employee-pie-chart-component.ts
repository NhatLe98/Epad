...
@Component({
  name: "DepartmentEmployeePieChart",
  components: { CustomLegendPieChart },
})
export default class DepartmentEmployeePieChartComponent extends Mixins(ComponentBase) {
  @Prop() index: any;
  id = "department-employee-pie-chart";
  @Prop() name;
  employeeData: any;
  chartLabels: any;
  chartIds: any;
  ...
  beforeMount(){
    ...
    hrEmployeeInfoApi.GetEmployeeInfoByUserDepartment().then((res: any) => {

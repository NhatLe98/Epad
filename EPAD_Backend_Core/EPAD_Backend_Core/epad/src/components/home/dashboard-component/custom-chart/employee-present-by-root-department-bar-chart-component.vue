<template>
  <div style="max-height: 90%;" v-loading="!load">
    <CustomLegendBarChart
      ...
      :dataSets="chartSets"
      :XValueColor="textChartColor"
      :YValueColor="textChartColor"
...
<script src="./employee-present-by-root-department-bar-chart-component.ts"></script>

  ...
  <div class="tab" style="height: calc(100vh - 185px)">
    ...
    <div class="tab-modal"> 
      <el-dialog
        ...
        :title="
          isEdit
            ? $t('EditFixedDepartmentSchedule')
            : $t('InsertFixedDepartmentSchedule')
        "
          ...
          <el-form-item :label="$t('SelectFile')">
            <div class="box">
              <input
                ...
                type="file"
                name="file-3[]"
                id="fileUploadScheduleDepartment"
                class="inputfile inputfile-3"
                @change="processFile($event)"
              />
              <label for="fileUploadScheduleDepartment">
                <svg
          ...
          <div>
            <el-form-item :label="$t('DownloadTemplate')">
              <a
                ...
                href="/Template_ScheduleDepartment.xlsx"
                download
                >{{ $t("Download") }}</a
              >
            </el-form-item>
      ...
      >
        <el-form label-width="168px" label-position="top">
          ...
          <el-form-item>
            <a
              class="fileTemplate-lbl"
              href="/Files/Template_ScheduleDepartment_Error.xlsx"
              download
              >{{ $t("Download") }}</a
            >
          </el-form-item>
...
<script src="./ta-fixed-department-schedule.ts"></script>
<style scoped>
.hozitalClass {
  display: flex;
  flex-direction: row;

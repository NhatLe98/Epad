...
export default class HREmployeeInfo extends Mixins(TabBase) {
    ...
    async beforeMount() {
        ...
        Misc.readFileAsync('static/variables/common-utils.json').then(x => {
            ...
            console.log("HREmployeeInfo ~ Misc.readFileAsync ~ clientName:", this.clientName)
        ...
        await employeeInfoApi.ExportTemplateICEmployee().then((res: any) => {
            // console.log(res);
        })
    }
    ...
    onChangeDepartmentFilter(departments) {
        this.$emit('dataDepartment', departments);
	}

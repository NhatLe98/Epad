  ...
  <div class="tab" style="height: calc(100vh - 185px)">
    <div class="tab-filter">
      <el-row>
        ...
        <el-col :span="4">
          <app-select-new class="register-for-leave__filter-employee"
    ...
    <div class="tab-modal">
      <el-dialog
        ...
        width="800px"
        :title="isEdit ? $t('EditLeaveRegistration') : $t('InsertLeaveRegistration')"
      ...
      >
        ...
        >
          <el-row :gutter="10">
            ...
            <el-col :span="12">
              ...
              >
                <app-select-new :disabled="isEdit" :dataSource="employeeFullLookupForm" displayMember="NameInFilter" valueMember="Index"
                  :allowNull="true" v-model="formModel.ListEmployeeATID" :multiple="true" style="width: 100%"
                  :placeholder="$t('SelectEmployee')" @getValueSelectedAll="selectAllEmployeeForm" ref="employeeList">
                  </app-select-new>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="12" v-if="isEdit">
              <el-form-item :label="$t('LeaveDate')" prop="LeaveDate">
                <el-date-picker
                  ref="LeaveDate"
                  v-model="formModel.LeaveDate"
                  type="date"
                  :clearable="false"
                ></el-date-picker>
              </el-form-item>
            ...
            <el-col :span="12">
              ...
              prop="LeaveDateType"
              >
                <el-select v-model="formModel.LeaveDateType" clearable 
                  :placeholder="$t('SelectLeaveDateType')">
                  <el-option
                    v-for="item in listLeaveDateType"
                    :key="item.Index"
                    :label="item.Name"
                    :value="item.Index"
                  >
            ...
            <el-col :span="12">
              ...
              prop="LeaveDurationType"
              >
                <el-select v-model="formModel.LeaveDurationType" clearable
                  :placeholder="$t('SelectLeaveDurationType')">
                  <el-option
                    v-for="item in listLeaveDurationType"
                    :key="item.Index"
                    :label="item.Name"
                    :value="item.Index"
                  >
            ...
            <el-col :span="12">
            <el-form-item v-if="formModel.LeaveDurationType == 2"
              :label="$t('Type')"
              prop="HaftLeaveType"
              >
                <el-select v-model="formModel.HaftLeaveType" clearable
                  :placeholder="$t('SelectType')">
                  <el-option
                    v-for="item in listHaftLeaveType"
                    :key="item.Index"
                    :label="item.Name"
                    :value="item.Index"
                  >
      ...
      >
        <el-form label-width="168px" label-position="top">
          ...
          <el-form-item>
            <a
              class="fileTemplate-lbl"
              href="/Files/EmployeeLeaveDayError.xlsx"
              download
              >{{ $t("Download") }}</a
            >
          </el-form-item>
...
<script src="./register-for-leave.ts"></script>
<style lang="scss">
.btn-close {
...
.register-for-leave__filter-employee .el-select__tags:not(:has(span span:nth-child(2))) {
  top: 50% !important;
...
.register-for-leave__filter-employee .el-select__tags:has(span span:nth-child(2)) {
  top: 50% !important;

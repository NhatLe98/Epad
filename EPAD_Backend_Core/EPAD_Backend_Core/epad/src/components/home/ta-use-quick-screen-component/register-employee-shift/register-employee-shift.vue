    ...
    <div class="tab-filter">
      <el-row>
        <el-col :span="4">
          <select-department-tree-component
            ...
            v-model="filterModel.SelectedDepartmentFilter"
        ...
        <el-col :span="5">
          <app-select-new class="register-employee-shift__filter-employee"
            ...
            valueMember="Index"
            :allowNull="true"
            v-model="filterModel.SelectedEmployeeATIDFilter"
            :multiple="true"
      ...
      >
        ...
        <el-col :span="1" style="float: right">
          <TableToolbar v-show="false" ref="customerDataTableFunction" :gridColumnConfig.sync="columnDefs" />
        </el-col>
        <el-col :span="1" style="float:right;">
          <el-tooltip
          class="item"

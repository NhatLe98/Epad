...
@Component({
    name: 'ajust-attendance-log',
    components: {
        HeaderComponent, DataTableComponent, DataTableFunctionComponent, SelectDepartmentTreeComponent, VisualizeTable,
        AppPagination, timePicker, TableToolbar
    },
})


export default class AjustAttendanceLog extends Mixins(TabBase) {
    page = 1;
    showDialog = false;
    showMessage = false;
    checked = false;
	...
	dataEmployeeFilterChange(){
		this.EmployeeATIDsFilter = this.employeeFilter;
	}
    ...
    viewData(){
        ...
        this.filterModel.SelectedEmployeeATIDFilter = this.EmployeeATIDsFilter;
    ...
    onSelectionChange(selectedRows: any[]) {
        ...
        this.$emit('selectedRowKeys', this.selectedRows);
    }
    ...
    // onEditClick() {
    //     this.isEdit = true;
    //     // this.ruleForm = Misc.cloneData(this.selectedRows[0]);
    //     // const obj: any = {AttendanceDate: new Date(), AttendanceTime: new Date()};
    //     let a  = JSON.parse(JSON.stringify(this.selectedRows[0]));
    //     a.DepartmentIDs = [a.DepartmentIndex]
    //     a.EmployeeATID = a.EmployeeATID
    //     console.log(new Date(a.ProcessedCheckTime));
    //     a.AttendanceDate = new Date( a.ProcessedCheckTime)
    //     a.AttendanceTime =  new Date( a.ProcessedCheckTime)
    //     this.ruleForm = a;
    //    this.showDialog = true;
    // }
